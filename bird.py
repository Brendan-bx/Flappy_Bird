...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midtop=(800, random_pipe_pos - 300))
...
bird_surface = pygame.image.load("assets/bird_sing.png").convert()
bird_surface = pygame.transform.scale2x(bird_surface)
bird_rect = bird_surface.get_rect(center=(100, 400))

pipe_surface = pygame.image.load("assets/tube2.png")
pipe_surface = pygame.transform.scale2x(pipe_surface)
pipe_list = []
SPAWNPIPE = pygame.USEREVENT
pygame.time.set_timer(SPAWNPIPE, 1200)
pipe_heigt = [400, 600, 800]
...
while True:
    ...
    bird_mouvement += gravity
    bird_rect.centery += bird_mouvement
